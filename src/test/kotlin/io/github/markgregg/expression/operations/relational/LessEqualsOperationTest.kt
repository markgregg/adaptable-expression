...
class LessEqualsEqualsOperationTest  : FunSpec() {

    init {
        context("Less equals strings positive") {
            listOf(
                ...
                test("LessEquals ${it.first} with string") {
                    LessEqualsOperation(StringOperation(it.third), it.second)
                        .execute(mock(io.github.markgregg.expression.Context::class.java)) shouldBe true
                }
            }
        }

        context("Less equals strings negative") {
            listOf(
        ...
        context("Less equals long positive") {
            listOf(
                Triple("string", StringOperation("1000"), 1000L),
                Triple("boolean", BooleanOperation(false), 0L),
                Triple("long", LongOperation(1000), 900L),
                Triple("double", DoubleOperation(100.10), 90L)
            ).forEach {
                test("LessEquals ${it.first} with long") {
                    LessEqualsOperation(LongOperation(it.third), it.second)
                        .execute(mock(io.github.markgregg.expression.Context::class.java)) shouldBe true
                }
            }
        }

        context("Less equals long negative") {
            listOf(
        ...
        context("Less equals double positive") {
            listOf(
                Triple("string", StringOperation("1000.0"), 1000.0),
                Triple("boolean", BooleanOperation(false), 0.0),
                Triple("long", LongOperation(1000), 900.0),
                Triple("double", DoubleOperation(100.10), 30.10)
            ).forEach {
                test("LessEquals ${it.first} with double") {
                    LessEqualsOperation(DoubleOperation(it.third), it.second)
                        .execute(mock(io.github.markgregg.expression.Context::class.java)) shouldBe true
                }
            }
        }

        context("Less equals double negative") {
            listOf(
        ...
        context("Less equals date positive") {
            listOf(
                ...
                test("LessEquals ${it.first} with date") {
                    LessEqualsOperation(DateOperation(it.third), it.second)
                        .execute(mock(io.github.markgregg.expression.Context::class.java)) shouldBe true
                }
            }
        }

        context("Less equals date negative") {
            listOf(
        ...
        context("Less equals datetime positive") {
            listOf(
                ...
                test("LessEquals ${it.first} with date") {
                    LessEqualsOperation(DateTimeOperation(it.third), it.second)
                        .execute(mock(io.github.markgregg.expression.Context::class.java)) shouldBe true
                }
            }
        }

        context("Less equals datetime negative") {
            listOf(
        ...
        context("Less equals not handled") {
            listOf(
                Pair("boolean", false )
            ).forEach {
                test("LessEquals ${it.first} not handled") {
                    shouldThrow<IncompatibleTypeException> {
                        LessEqualsOperation(BooleanOperation(it.second), BooleanOperation(it.second))
