...
import org.adaptable.expression.exceptions.InvalidDateException
import org.adaptable.expression.exceptions.MissingSymbolException
import org.adaptable.expression.exceptions.ParseException
import org.adaptable.expression.exceptions.UnknownFunctionException
...
class ExpressionParserTest : FunSpec() {
    ...
    init {
        ...
        test("Conditional operator") {
            Util.parser.parse(Util.tokeniser.tokenise("12 + 12 * 2 > 36 / 12 + 12 ? 'is true' : 'is false'")).execute(mock(Context::class.java)) shouldBe "is true"
        }
