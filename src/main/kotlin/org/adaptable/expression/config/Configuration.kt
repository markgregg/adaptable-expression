...
import org.adaptable.expression.operations.arithematic.*
import org.adaptable.expression.operations.field.ArrayOperation
import org.adaptable.expression.operations.field.ContextOperation
import org.adaptable.expression.operations.field.FieldOperation
import org.adaptable.expression.operations.functions.Function
import org.adaptable.expression.operations.functions.FunctionDeclaration
import org.adaptable.expression.operations.functions.Functions
import org.adaptable.expression.operations.functions.ParameterlessFunction
import org.adaptable.expression.operations.logical.AndOperation
import org.adaptable.expression.operations.logical.ConditionalOperation
import org.adaptable.expression.operations.logical.NotOperation
import org.adaptable.expression.operations.logical.OrOperation
import org.adaptable.expression.operations.relational.*
...
class Configuration internal constructor(typeLoader: TypeLoader){
    ...
    private fun loadExtensionFunctions(typeLoader: TypeLoader): Map<String, FunctionDeclaration> {
        return typeLoader.getExtensions().map { clazz ->
            clazz.declaredMethods.filter { method ->
                method.getAnnotation(org.adaptable.expression.annotations.Functions::class.java) != null
            }.map { method ->
                Pair(clazz.getConstructor().newInstance(), method)
            }
        }.flatMap {
